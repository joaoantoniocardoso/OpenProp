% -------------------------------------------------------------------------
% Detailed propeller design example.
% -------------------------------------------------------------------------
...
Js_all        = [0.4:0.05:1.1, 1.12:0.02:1.16];     % advance coefficient
...
fig;
    ...
    % Design point
    plot(d.Js*[1 1],[0 2],'k--','LineWidth',1);
...
fig;
    ...
    for i = 1:length(pt.states.L)
        plot(pt.design.RC,pt.states.G(i,:),'k')     
    end
    xlabel('r/R'), ylabel('G')
    plotaxes,
